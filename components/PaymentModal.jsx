...
const PLANS = [
  {
    ...
    period: '/mes',
    badge: null,
    features: ['PDFs ilimitados', 'Flashcards desbloqueadas', 'Dificultad personalizable', 'Soporte prioritario'],
  ...
  },
  {
    ...
    period: '/mes',
    badge: '🏆 Más popular',
    features: ['Todo lo de Premium', 'Ahorra un 20%', 'Facturación anual', 'Acceso anticipado'],
  ...
  },
  {
    ...
    period: '/mes',
    badge: null,
    features: ['Hasta 10 usuarios', 'PDFs ilimitados', 'Panel de administrador', 'Analytics de uso'],
